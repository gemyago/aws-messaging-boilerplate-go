...
import (
	...
	services "github.com/gemyago/aws-sqs-boilerplate-go/internal/services"
)
...
func (_m *mockMessagesCommands) ProcessMessage(_a0 context.Context, _a1 *services.Message) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *services.Message) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *mockMessagesCommands_ProcessMessage_Call) Run(run func(_a0 context.Context, _a1 *services.Message)) *mockMessagesCommands_ProcessMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*services.Message))
	})
	return _c
}
...
func (_c *mockMessagesCommands_ProcessMessage_Call) RunAndReturn(run func(context.Context, *services.Message) error) *mockMessagesCommands_ProcessMessage_Call {
	_c.Call.Return(run)
	return _c
}
